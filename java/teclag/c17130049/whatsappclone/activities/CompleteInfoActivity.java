...
public class CompleteInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonConfirm.setOnClickListener(view -> {
            ...
            if (!mUsername.equals("") && mImageFile != null) {
                ...
                Toast.makeText(CompleteInfoActivity.this, "Debe seleccionar la imagen y ingresar su nombre de usuario", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void goToHomeActivity() {
        ...
        mDialog.dismiss();
        Toast.makeText(CompleteInfoActivity.this, "Se almaceno correctamente", Toast.LENGTH_SHORT).show();
